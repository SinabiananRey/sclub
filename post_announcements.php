...
$edit_id = isset($_POST['edit_announcement_id']) ? $_POST['edit_announcement_id'] : null;
$edit_title = '';
$edit_content = '';
...
<head>
    ...
    <style>
        body { margin: 0; font-family: Arial, sans-serif; background: #f4f4f4; display: flex; min-height: 100vh; }
        ...
        .main-content { margin-left: 250px; padding: 30px; width: calc(100% - 250px); background: #fff; min-height: 100vh; }
        h2, h3 { color: #003366; text-align: center; }
        .message { text-align: center; font-weight: bold; margin-bottom: 20px; }
        .success { color: green; }
        .error { color: red; }
        .form-container { max-width: 700px; margin: 0 auto 40px; }
        form { display: flex; flex-direction: column; gap: 15px; }
        label { font-weight: bold; color: #003366; }
        input[type="text"], textarea { padding: 12px; border-radius: 5px; border: 1px solid #ccc; font-size: 16px; width: 100%; }
        button[type="submit"], .delete-btn, .edit-btn { background-color: #003366; color: white; padding: 12px; border: none; font-size: 16px; border-radius: 5px; cursor: pointer; }
        button[type="submit"]:hover, .delete-btn:hover, .edit-btn:hover { background-color: #0055aa; }
        .announcement-table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        .announcement-table th, .announcement-table td { border: 1px solid #ccc; padding: 16px; text-align: left; vertical-align: top; }
        .announcement-table th { background-color: #003366; color: white; }
        .announcement-table td { background-color: #f9f9f9; }
